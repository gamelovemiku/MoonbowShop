...
<nav class="breadcrumb is-small" aria-label="breadcrumbs">
    ...
    <li><a href="{{route('forumcontrol.index')}}">Forum Category</a></li>
        <li class="is-active"><a href="{{route('forumcontrol.index')}}">Edit Category</a></li>
    </ul>
</nav>

<div class="columns">
    <div class="column is-6">
        <h4 class="title is-size-4 has-text-weight-bold">Edit Forum Category</h4>
        ...
        <div class="column is-12">
            <div class="field is-horizontal">
                ...
                <div class="field-body">
                    <div class="field">
                        <div class="control">
                            <input class="input" type="text" name="category_name" value="{{ $category->forum_category_name }}">
                            @error('category_name')
            ...
            <div class="field is-horizontal">
                ...
                <div class="field-body">
                    <div class="field">
                        <div class="control">
                            <textarea class="textarea" rows="12" name="description">{{ $category->forum_category_description }}</textarea>
                            @error('description')
                                <p class="help is-danger">{{ $message }}</p>
                            @enderror
                        </div>
