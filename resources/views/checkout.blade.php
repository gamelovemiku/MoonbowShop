...
<body>
    ...
    <section class="section">
        <div class="container is-uppercase">
            <h1 class="title is-size-1 force-bold">Check out</h1>
            <p class="subtitle">This action will be appear to "<b class="force-bold">{{ Auth::user()->name }}</b>"</p>
            <div class="columns">
                <div class="column is-12">
                    ...
                    <div class="buttons is-right">
                        <a class="button is-black">Confirm Checkout</a>
